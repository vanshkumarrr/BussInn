...
const DriverProfile = () => {
  ...
  // 1. Global Language State (Safe default for SSR)
  ...
  // 2. Safe Profile State initialization (Defaults to 0 coins and ensures fresh start)
  ...
  useEffect(() => {
    ...
    setIsHindi(localStorage.getItem("bussinn_lang") === "hi");
    ...
    const loadProfileData = () => {
      ...
      // If balance has never been recorded, set it to 0 initially
      if (savedCoins === null) {
  ...
  const handleLogout = () => {
    if (typeof window !== "undefined") {
      ...
      localStorage.removeItem("driver_coins_balance");
    }
    navigate({ to: "/login" });
  };
      ...
      <div className="app-content profile-layout">
        ...
        <main className="profile-content">
          ...
          <div className="menu-card-list">
            ...
            <Link to="/feedback" search={{ from: "driver" }} className="menu-item">
              <div className="menu-icon-box bg-gray-light">
                <svg viewBox="0 0 24 24" fill="none" stroke="#5f6368" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button onClick={handleLogout} className="btn-logout cursor-pointer" type="button">
